 ...
 * depends    tooling/kernel, tooling/planner-engine
 * used by    tooling/sandbox/index
...
/**
 * Light Tower VM — kernel + fixture decode + planner citation eval.
...
export function runTowerVm(
  ...
  step('vm.kernel', () => {
    ...
    return { ok: ctx.ok, saveNodes: ctx.graphs.save.nodeCount }
  })

  step('vm.decode-fixture', () => {
    const rel = req.savePath ?? 'packages/sdk/fixtures/save/perk-preferences.sample.json'
