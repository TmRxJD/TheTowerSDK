 ...
 */
/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    DebugTraceRecord, DebugErrorRecord, DebugSessionEvent, debugSessionDir, ensureSessionDir, appendSessionEvent, readSessionEvents, previewValue (+1 more)
 * depends    tooling/paths
 * used by    tooling/debug-graph/index, tooling/debug-graph/trace, tooling/sandbox/index
...
/** The monorepo root, named once in `tooling/paths.ts` rather than counted from here. */
