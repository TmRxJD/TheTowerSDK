/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    ORACLE_NODE_ID_PREFIX, sdkNodeIdForOracleNode, oracleGraphToSdkModule, oracleModuleNodeCount
 * depends    src/knowledge, src/knowledge/substrate/schema, tooling/sdk-graph/schema
 * used by    tooling/coverage/oracle-links, tooling/sdk-graph/index
 * ─────────────────────────────────────────────── generated by `npm run map` ──
 */
import { GAME_KNOWLEDGE } from '../../src/knowledge'
import type { KnowledgeNode } from '../../src/knowledge/substrate/schema'
