...
import { PERK_CONSUMER_METHODS, PERKS_APPLIED_TO_ENEMY_BASE } from '../../src/knowledge/compartments/perks'
import { PERK_IMPORT_CATALOG, PERK_UW_INDICES } from '../../src/save/catalogs/perks'
