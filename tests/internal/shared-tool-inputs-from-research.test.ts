...
import {
  ...
  syncUptimeResearchLabsFromProgress,
} from '../../src/internal/shared-tool-inputs/from-research'
...
describe('syncUptimeResearchLabsFromProgress', () => {
  it('maps uptime research lab fields from tracker levels', () => {
    const uptime = syncUptimeResearchLabsFromProgress({
