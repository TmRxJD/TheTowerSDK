 ...
 * depends    —
 * used by    src/data/index, src/mechanics/elite-spawn-chance, src/mechanics/enemy-drops-simulation, src/mechanics/resource-drops-coin-simulation, src/mechanics/wave-accelerator-spawn-rate-cap
