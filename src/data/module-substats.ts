 ...
 * depends    —
 * used by    src/data/index, src/mechanics/calculators/specs-generated, src/mechanics/els-calculator-options, src/mechanics/resource-drops-coin-module-cpk, src/save/module-effects-decode, src/save/module-effects-display (+2 more)
