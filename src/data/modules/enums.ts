 ...
 * depends    —
 * used by    src/data/modules/effect-resolver, src/data/modules/index, src/save/modules/registry
...
/** Map effect rarity enum value to its substat rarity label. */
