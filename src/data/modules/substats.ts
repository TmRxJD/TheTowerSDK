/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    ModuleSubstatCanonicalCategory, ModuleSubstatCanonicalRarity, ModuleSubstatCanonicalDefinition, ModuleSubstatCanonicalCategoryData, MODULE_SUBSTAT_BASE_RARITIES, MODULE_SUBSTAT_CANONICAL_DATA, MODULE_SUBSTATS_MISSING_FROM_CHART, findModuleSubstatDefinition
 * depends    —
 * used by    src/data/modules/index, src/mechanics/calculators/specs-generated, src/mechanics/modules/els-calculator-options, src/mechanics/resource-drops/coin-module-cpk, src/save/modules/decode, src/save/modules/display (+2 more)
 ...
 *
 * The chart is what this catalog mirrors, so a substat missing from it is
