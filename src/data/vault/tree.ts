/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    VaultTreeNode, harmonyTreeNodes, powerTreeNodes, DEFAULT_HARMONY_VAULT_NODES, DEFAULT_POWER_VAULT_NODES, buildVaultTreeRows, VaultTreeKey, VaultTreeDefinition (+3 more)
 * depends    —
 * used by    src/data/vault/index, src/data/vault/tree-traversal, src/knowledge/compartments/vault, src/mechanics/calculators/specs-generated, src/mechanics/effective-paths/edamage-costs, src/mechanics/effective-paths/input-ranges (+2 more)
