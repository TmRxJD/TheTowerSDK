 ...
 * depends    src/data/workshop/table.json, src/mechanics/enemies/level-skip
 * used by    src/data/workshop/compute, src/data/workshop/enhancement-progress-definitions, src/data/workshop/index, src/mechanics/calculators/run, src/mechanics/calculators/specs-generated, src/mechanics/modules/els-calculator-options (+6 more)
 * ─────────────────────────────────────────────── generated by `npm run map` ──
 */
import { LEVEL_SKIP_WORKSHOP_BASE } from '../../mechanics/enemies/level-skip'
import workshopData from './table.json'
