/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    WorkshopEnhancementStatDefinition, getWorkshopEnhancementDefinitions
 * depends    src/data/workshop/costs, src/data/workshop/progress-definitions
 * used by    src/data/workshop/index, src/mechanics/calculators/run, src/mechanics/effective-paths/enhancement-costs, src/mechanics/modules/els-calculator-options, src/save/effective-paths/from-save, src/save/ids/import-blocks (+4 more)
 * ─────────────────────────────────────────────── generated by `npm run map` ──
 */
import { getWorkshopMaxLevelByKey } from './costs'
import type { WorkshopCategory } from './progress-definitions'
