/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    TierBattleConditionDefinition, TierBattleConditionValue, TierData, TierCoinBonusRow, TierUnlockRequirementRow, TierBattleConditionRow, TIER_OVERVIEW_FACTS, TIER_BATTLE_CONDITION_DEFINITIONS (+10 more)
 * depends    src/data/battle-conditions/names
 * used by    src/data/index, src/data/tiers/index, src/data/tournaments/data, src/knowledge/compartments/progression, src/mechanics/battle-conditions/config, src/mechanics/battle-conditions/tournament-heat-bc (+1 more)
 * ─────────────────────────────────────────────── generated by `npm run map` ──
 */
import { canonicalBattleConditionName } from '../battle-conditions/names'
