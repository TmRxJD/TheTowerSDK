 ...
 * depends    —
 * used by    src/data/index, src/data/vault-tree-traversal, src/knowledge/compartments/vault, src/mechanics/calculators/specs-generated, src/mechanics/effective-paths-edamage-costs, src/mechanics/effective-paths-input-ranges (+2 more)
