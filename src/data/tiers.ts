 ...
 * depends    src/data/battle-condition-names
 * used by    src/data/index, src/data/tournaments, src/knowledge/compartments/progression, src/mechanics/battle-condition-config, src/mechanics/calculators/specs-generated, src/mechanics/tournament-heat-bc
