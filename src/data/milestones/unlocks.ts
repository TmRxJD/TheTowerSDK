 ...
 */
/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    MilestoneSystemUnlock, MILESTONE_SYSTEM_UNLOCK_ROWS, findMilestoneUnlockFor, NON_MILESTONE_GATES
 * depends    src/data/milestones/milestones
 * used by    src/data/milestones/index, src/knowledge/compartments/guild, src/knowledge/compartments/progression, src/mechanics/calculators/specs-generated
 ...
 */
export const MILESTONE_SYSTEM_UNLOCK_ROWS: readonly MilestoneSystemUnlock[] = SYSTEM_PATTERNS
  .map(([system, pattern]) => {
...
export function findMilestoneUnlockFor(system: string): MilestoneSystemUnlock | null {
  return MILESTONE_SYSTEM_UNLOCK_ROWS.find(entry => entry.system === system) ?? null
}
