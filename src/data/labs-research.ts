 ...
 * depends    src/data/labs-catalog, src/data/labs-research-data
 * used by    src/data/index, src/data/labs, src/data/labs-categories, src/data/labs-display-overrides, src/data/research-lab-level, src/internal/bot-lab-levels-from-research (+5 more)
