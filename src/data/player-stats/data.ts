/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    PLAYER_DATA_FIELDS_BY_DOMAIN, TOWER_MODULE_RARITY_ENUM, RESEARCH_CATEGORY_ENUM, RELIC_ENUM, TECH_TREE_STAT_ENUM, CARD_IMPORT_CATALOG, LAB_RESEARCH_IMPORT_CATALOG, VAULT_HARMONY_IMPORT_CATALOG (+5 more)
 * depends    —
 * used by    src/data/index, src/data/labs/display-overrides, src/data/player-stats/index, src/knowledge/compartments/guardian, src/save/cards/read, src/save/catalogs/guardians (+7 more)
 * ─────────────────────────────────────────────── generated by `npm run map` ──
 */
// Tower player-data field catalog.
// Source: tower player-data schema

export const PLAYER_DATA_FIELDS_BY_DOMAIN = {
  'labs': [
    {
      'name': 'labsUnlocked',
      'type': 'int',
  ...
  'modules': [
    ...
    {
      'name': 'currentModulePreset',
      'type': 'int',
    },
    {
      'name': 'hasMigratedModuleLevelsToSlots',
      'type': 'bool',
    },
    {
      'name': 'hasShownSlotLevelMigrationPopup',
      'type': 'bool',
    },
    {
      'name': 'slotLevelMigrationRefundCoins',
      'type': 'double',
    },
    {
      'name': 'slotLevelMigrationRefundCannonShards',
      'type': 'int',
    },
    {
      'name': 'slotLevelMigrationRefundArmorShards',
      'type': 'int',
    },
    {
      'name': 'slotLevelMigrationRefundGeneratorShards',
      'type': 'int',
    },
    {
      'name': 'slotLevelMigrationRefundCoreShards',
      'type': 'int',
    },
    {
      'name': 'moduleRecords',
  ...
  'other': [
    ...
    {
      'name': 'totalEnemiesDestroyedByOrbs',
      'type': 'double',
    },
    {
    ...
    {
      'name': 'enemiesDestroyedByOrbsThisRound',
      'type': 'double',
    },
    {
    ...
    {
      'name': 'currentGlobalPreset',
      'type': 'int',
    },
    {
      'name': 'globalPresetApplied',
      'type': 'bool',
    },
    {
      'name': 'tierPreset',
    ...
    {
      'name': 'dissonantPreset',
      'type': 'int',
    },
    {
      'name': 'refundedBastionCard',
      'type': 'bool',
    },
    {
      'name': 'bastionBlockedThisRound',
      'type': 'double',
    },
    {
      'name': 'bastionPool',
    ...
    {
      'name': 'bastionMasteryBlockTimeoutWave',
      'type': 'int',
    },
    {
      'name': 'bastionUsedThisRound',
      'type': 'bool',
    },
    {
      'name': 'bastionOffCooldown',
      'type': 'bool',
    },
    {
      'name': 'bastionWavesUntilRefresh',
      'type': 'int',
    },
    {
      'name': 'bastionAutomateToggle',
      'type': 'bool',
    },
    {
...
// TOWER_SUBSTATS_CLUSTER was a byte-for-byte duplicate of MODULE_SUBSTATS_CLUSTER
// (modules/enums) with no consumer of its own — deleted. Use that one directly.

// TOWER_EFFECT_RARITY_ENUM / TOWER_MODULE_TYPE_ENUM / ASSIST_MODULE_SLOT_TYPE_ENUM were
// byte-for-byte copies of MODULE_EFFECT_RARITY_ROWS / MODULE_TYPE_ROWS (modules/enums)
// — deleted; use those.
...
export const RELIC_ENUM = [
  ...
  {
    'relic': 'MassiveAbduction',
    'value': 318,
    'label': 'Massive Abduction',
  },
  {
    'relic': 'GeneticModification',
    'value': 319,
    'label': 'Genetic Modification',
  },
  {
    'relic': 'AlienEncounter',
    'value': 320,
...
/** Save cardLevel[i] / cardCount[i] index → card slug and display name. */
/**
...
export const CARD_IMPORT_CATALOG = [
  ...
  // Index 36 = CardID.Bastion — present in binary, pulled before release; leave null.
  { index: 36, gameField: null, slug: null, name: null },
  // Index 37 = CardID.Cells (v29 shipped).
  { index: 37, gameField: 'cardCells', slug: 'cells', name: 'Cells' },
 ...
 * `targetKey` sits on the ChipType whose name matches the player-facing chip —
...
/**
 * Save guardianChipUnlocked[i] / guardianChipLevel[i] index -> ChipType and guardian key.
