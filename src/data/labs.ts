 ...
 * depends    src/data/labs-catalog, src/data/labs-categories, src/data/labs-research, src/formatting/index
 * used by    src/data/index, src/data/labs-categories, src/data/labs-display-overrides, src/internal/labs-persistence, src/mechanics/calculators/run, src/mechanics/calculators/specs-generated (+4 more)
