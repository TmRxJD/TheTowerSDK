 ...
 * depends    src/data/workshop-costs, src/data/workshop-tracker-definitions
 * used by    src/data/index, src/mechanics/calculators/run, src/mechanics/effective-paths-enhancement-costs, src/mechanics/els-calculator-options, src/save/effective-paths-from-save, src/save/ids-import-blocks (+4 more)
