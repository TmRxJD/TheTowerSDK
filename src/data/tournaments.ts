/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    TournamentLeague, TournamentScheduleSlot, TournamentUnlockRequirement, TournamentTicketModel, TournamentLeagueDefinition, TournamentPromotionRule, TournamentHeatProfile, TournamentRewardRow (+35 more)
 * depends    src/data/campaign-tier, src/data/tiers, src/internal/own-lookup
 * used by    src/data/index, src/internal/enemy-stats-calcs-local-state, src/internal/shared-tool-inputs-extended, src/knowledge/compartments/meta-game, src/mechanics/battle-condition-config, src/mechanics/calculators/specs-generated (+1 more)
