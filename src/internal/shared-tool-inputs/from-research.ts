/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    readLabsEconomyFromResearchLevels, readWorkshopDiscounts, readModuleEconomyFromResearchLevels, readEchoLabLevelsFromResearchLevels, readNamedCalculatorLabs, syncUptimeResearchLabsFromProgress, EnrichSharedToolInputsFromResearchOptions, enrichSharedToolInputs (+1 more)
 * depends    src/data/labs/research-level, src/data/workshop/discount-normalize, src/internal/persistence/labs-persistence, src/internal/shared-tool-inputs/shared-tool-inputs, src/internal/uptime/shared-inputs, src/mechanics/labs/constants
 * used by    src/mechanics/calculators/specs-generated, src/save/shared-tool-inputs/from-save, src/save/shared-tool-inputs/from-save-extended
 * ─────────────────────────────────────────────── generated by `npm run map` ──
 */
import { computeResearchLabLevel } from '../../data/labs/research-level'
import { DISSONANT_ECHO_LAB_SLUG_BY_TYPE as DISSONANCE_ECHO_LAB_SLUG_BY_TYPE } from '../../mechanics/labs/constants'
import { defaultSharedLabsSettings, type SharedLabsSettings } from '../persistence/labs-persistence'
import {
...
export { computeResearchLabLevel } from '../../data/labs/research-level'
...
export function syncUptimeResearchLabsFromProgress(
  researchLabLevels: Record<string, number>,
...
>(payload: T, options?: EnrichSharedToolInputsFromResearchOptions): T {
  ...
  return {
    ...
    uptimeInputs: syncUptimeResearchLabsFromProgress(researchLabLevels, payload.uptimeInputs),
  }
}
