/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    readElsPlannerLevels, syncWorkshopStatsFromElsPlanner, readElsVaultStarsFromVaultLevels, syncVaultLevelsFromElsPlanner, enrichElsPlannerFromLinkedSources
 * depends    src/internal/shared-tool-inputs/extended, src/mechanics/modules/els-module-cluster, src/mechanics/modules/els-upgrade-path
 * used by    src/internal/shared-tool-inputs/shared-tool-inputs, src/mechanics/calculators/specs-generated, src/save/shared-tool-inputs/from-save-extended
...
} from '../../mechanics/modules/els-upgrade-path'
import {
