/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    sharedTradeOffPerksSchema, SharedTradeOffPerks, defaultSharedTradeOffPerks, sharedWorkshopDiscountsSchema, SharedWorkshopDiscounts, defaultSharedWorkshopDiscounts, sharedModuleDiscountsSchema, SharedModuleDiscounts (+52 more)
 * depends    src/data/workshop/discount-normalize, src/internal/persistence/labs-persistence, src/internal/shared-tool-inputs/extended, src/internal/shared-tool-inputs/field-sync, src/internal/shared-tool-inputs/hub-merge, src/internal/shared-tool-inputs/storage (+2 more)
 * used by    src/internal/shared-tool-inputs/from-research, src/internal/shared-tool-inputs/storage, src/mechanics/calculators/specs-generated, src/mechanics/resource-drops/coin-context, src/mechanics/resource-drops/coin-module-cpk, src/save/shared-tool-inputs/from-save
...
export type { SharedPerkPreferences } from '../../save/perks/read'
export {
  defaultSharedPerkPreferences,
