 ...
 * depends    src/data/tournaments, src/internal/bot-medal-splitter-local-state, src/internal/calculator-local-state-schemas, src/internal/cards-progress-inputs, src/internal/dissonance-calcs-local-state, src/internal/enemy-drops-calcs-local-state (+4 more)
 * used by    src/internal/shared-tool-inputs, src/internal/shared-tool-inputs-field-sync, src/internal/shared-tool-inputs-hub-merge, src/internal/shared-tool-inputs-storage, src/mechanics/calculators/specs-generated, src/mechanics/enemy-drops-context (+5 more)
