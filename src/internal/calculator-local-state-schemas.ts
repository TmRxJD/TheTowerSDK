 ...
 * depends    src/data/campaign-tier, src/data/workshop-discount-normalize, src/internal/bot-medal-planner-focus, src/internal/bot-medal-splitter-local-state, src/internal/bots-calcs-local-state, src/internal/dissonance-calcs-local-state (+8 more)
 * used by    src/internal/shared-tool-inputs-extended, src/mechanics/calculators/specs-generated, src/mechanics/thorns-calculator
