import { MAIN_SUB_COSTS } from '../data/module-costs'
...
export function getStoneCostOptions(costs: readonly number[] = MAIN_SUB_COSTS): StoneCostOption[] {
...
export function getStoneTargetOptions(options?: {
  ...
  const costs = options?.costs ?? MAIN_SUB_COSTS
