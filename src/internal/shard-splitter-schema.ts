 ...
 * depends    src/mechanics/assist-module-efficiency
 * used by    src/internal/calculator-local-state-schemas, src/internal/game-input-data/module-type-dropdown-math, src/internal/module-calculator-options, src/internal/shared-tool-inputs-extended, src/mechanics/calculators/specs-generated, src/save/shared-tool-inputs-from-save-extended
