/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    ModuleType, moduleTypes, moduleTypeSchema, SplitterData, SplitterByType, splitterDataSchema, splitterByTypeSchema, shardSplitterSnapshotSchema (+3 more)
 * depends    src/mechanics/modules/assist-module-efficiency
 * used by    src/internal/local-state/calculator-local-state-schemas, src/internal/module-calculator-options, src/internal/shared-tool-inputs/extended, src/mechanics/calculators/specs-generated, src/save/shared-tool-inputs/from-save-extended
 * ─────────────────────────────────────────────── generated by `npm run map` ──
 */
import { z } from 'zod'
import { MAX_ASSIST_MULTIPLIER_EFFICIENCY_PCT } from '../mechanics/modules/assist-module-efficiency'
