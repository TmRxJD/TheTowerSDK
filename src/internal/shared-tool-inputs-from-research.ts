/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    readLabsEconomyFromResearchLevels, readWorkshopDiscounts, readModuleEconomyFromResearchLevels, readEchoLabLevelsFromResearchLevels, readNamedCalculatorLabs, syncUptimeResearchLabsFromTracker, EnrichSharedToolInputsFromResearchOptions, enrichSharedToolInputs (+1 more)
 * depends    src/data/research-lab-level, src/data/workshop-discount-normalize, src/internal/game-input-data/dissonance-echo-lab-keys, src/internal/labs-persistence, src/internal/shared-tool-inputs, src/internal/shared-uptime-inputs
 * used by    src/internal/game-input-data/dropdown-evaluator, src/mechanics/calculators/run, src/mechanics/calculators/specs-generated, src/save/shared-tool-inputs-from-save, src/save/shared-tool-inputs-from-save-extended
