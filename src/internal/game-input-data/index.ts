/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    GAME_DATA_REGISTRY, isGameDataKey, findRegistryGameDataKey, GameDataKey, evaluateDropdownOptions, buildImportHubContextFromBotProgress, buildImportHubContextFromCardsProgress, buildImportHubContextFromCardSaveRows (+357 more)
 * depends    src/internal/game-input-data/bot-dropdown-math, src/internal/game-input-data/bot-game-input-keys, src/internal/game-input-data/card-template-dropdown-math, src/internal/game-input-data/cards-game-input-keys, src/internal/game-input-data/damage-reduction-dropdown-math, src/internal/game-input-data/dissonance-echo-lab-dropdown-math (+33 more)
 * used by    —
