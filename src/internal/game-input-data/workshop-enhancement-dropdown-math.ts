/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    WORKSHOP_ENHANCEMENT_KEY_ALIASES, getWorkshopEnhancementDataKey, computeWorkshopEnhancementMaxLevel, buildWorkshopEnhancementLevelEntries, formatWorkshopEnhancementOptionLabel, formatWorkshopEnhancementFieldLabel
 * depends    src/data/index, src/internal/game-input-data/types, src/internal/own-lookup
 * used by    src/internal/game-input-data/dropdown-evaluator, src/internal/game-input-data/index, src/internal/game-input-data/workshop-stat-dropdown-math, src/mechanics/calculators/specs-generated
