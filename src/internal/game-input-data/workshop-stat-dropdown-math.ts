/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    WorkshopTierKind, WorkshopStatSpec, WorkshopTierSpec, getWorkshopEnhancementKeyFromDataKey, findWorkshopEnhancementSpec, buildWorkshopStatLevelEntries, buildWorkshopStatOptionLabel, formatWorkshopStatFieldLabel (+3 more)
 * depends    src/data/index, src/internal/game-input-data/types, src/internal/game-input-data/workshop-enhancement-dropdown-math, src/mechanics/els-upgrade-path
 * used by    src/internal/game-input-data/dropdown-evaluator, src/internal/game-input-data/index, src/mechanics/calculators/specs-generated, src/mechanics/ilm-charge
