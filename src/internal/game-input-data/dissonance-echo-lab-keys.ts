/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    DISSONANCE_ECHO_LAB_SLUG_BY_TYPE, DissonanceEchoLabDataKey, DissonanceEchoLabSpec, DISSONANCE_ECHO_LAB_SPECS, DISSONANCE_ECHO_LAB_SPEC_BY_KEY, DISSONANCE_ECHO_LAB_SPEC_BY_TYPE, DISSONANCE_ECHO_LAB_SPEC_BY_SLUG, isDissonanceEchoResearchLabSlug (+7 more)
 * depends    src/internal/dissonance-calcs-local-state, src/internal/own-lookup
 * used by    src/internal/game-input-data/dissonance-echo-lab-dropdown-math, src/internal/game-input-data/dropdown-evaluator, src/internal/game-input-data/game-data-registry, src/internal/game-input-data/hub-context, src/internal/game-input-data/index, src/internal/game-input-data/research-lab-dropdown-math (+2 more)
