/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    isExtendedDropdownKey, evaluateExtendedDropdownOptions
 * depends    src/internal/game-input-data/card-template-dropdown-math, src/internal/game-input-data/cards-dropdown-math, src/internal/game-input-data/damage-reduction-dropdown-math, src/internal/game-input-data/enemy-tier-dropdown-math, src/internal/game-input-data/game-data-registry, src/internal/game-input-data/hub-context (+12 more)
 * used by    src/internal/game-input-data/dropdown-evaluator, src/mechanics/calculators/specs-generated
