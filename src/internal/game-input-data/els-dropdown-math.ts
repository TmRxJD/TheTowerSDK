/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    ElsModuleSubstatLabel, buildElsModuleSubstatRarityEntries, buildElsModuleSubstatRarityOptionLabel, computeElsModuleSubstatRarityIndex, getElsModuleSubstatRarityByIndex, buildElsWorkshopUtilityDiscountEntries, formatElsWorkshopUtilityDiscountOptionLabel, buildElsWorkshopEnhancementDiscountEntries (+7 more)
 * depends    src/internal/game-input-data/types, src/mechanics/els-calculator-options, src/mechanics/els-module-cluster
