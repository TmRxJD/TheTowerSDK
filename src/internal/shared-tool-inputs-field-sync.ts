 ...
 * depends    src/internal/shared-tool-inputs-extended, src/mechanics/els-module-cluster, src/mechanics/els-upgrade-path
 * used by    src/internal/shared-tool-inputs, src/mechanics/calculators/specs-generated, src/save/shared-tool-inputs-from-save-extended
