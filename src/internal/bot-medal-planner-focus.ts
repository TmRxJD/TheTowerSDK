/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    BOT_MEDAL_PLANNER_FOCUS_GOALS, BotMedalPlannerFocusGoal, BotMedalPlannerFocusWeights, BOT_PLUS_LEVEL_LOCKED, botMedalPlannerFocusGoalLabel, normalizeBotMedalPlannerFocusOrder, getBotMedalPlannerFocusWeights, normalizePlannerPlusLevel (+2 more)
 * depends    src/support/own-lookup
 * used by    src/internal/local-state/bot-medal-splitter, src/internal/local-state/calculator-local-state-schemas, src/mechanics/calculators/specs-generated
