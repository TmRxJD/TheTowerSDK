/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    BOT_MEDAL_SPLITTER_PRESET_COUNT, DEFAULT_BOT_MEDAL_SPLITTER_TOWER_RANGE, BotMedalSplitterTargetConfig, BotMedalSplitterShRarity, BotMedalSplitterPreset, BotMedalSplitterLocalState, targetBotMedalSplitterBotLabels, normalizeBotMedalSplitterSynced (+13 more)
 * depends    src/data/bots, src/internal/bot-medal-planner-focus, src/internal/local-persistence-types
 * used by    src/internal/calculator-local-state-schemas, src/internal/shared-tool-inputs-extended, src/mechanics/calculators/specs-generated, src/mechanics/resource-drops-coin-context
