 ...
 * depends    src/data/workshop-discount-normalize, src/internal/labs-persistence, src/internal/shared-tool-inputs-extended, src/internal/shared-tool-inputs-field-sync, src/internal/shared-tool-inputs-hub-merge, src/internal/shared-tool-inputs-storage (+2 more)
 * used by    src/internal/game-input-data/dropdown-evaluator, src/internal/game-input-data/hub-context, src/internal/shared-tool-inputs-from-research, src/internal/shared-tool-inputs-storage, src/mechanics/calculators/run, src/mechanics/calculators/specs-generated (+3 more)
