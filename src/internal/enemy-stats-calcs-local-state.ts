 ...
 * depends    src/data/tournaments, src/internal/local-persistence-types, src/mechanics/battle-condition-config, src/mechanics/els-calculator-options, src/mechanics/els-module-cluster, src/mechanics/enemy-wave-stats
 * used by    src/internal/calculator-local-state-schemas, src/internal/shared-tool-inputs-extended, src/mechanics/calculators/specs-generated
