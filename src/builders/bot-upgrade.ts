 ...
 */
/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    BotUpgradeInput, BotUpgradeLevel, BotUpgradeResult, botUpgradeCalculator
 * depends    src/builders/types, src/data/index
 * used by    src/builders/index
 * ─────────────────────────────────────────────── generated by `npm run map` ──
 */
import { BOT_UPGRADES_DATA, botStatMaxLevel, findBotByName, type BotData } from '../data/index'
