...
import type { ModuleCostInput, ModuleCostLevel, ModuleCostResult } from './types'
...
export const moduleCostCalculator: CalculatorBuilder<ModuleCostInput, ModuleCostResult> = {
  ...
  compute(rawInput = {}) {
    ...
    if (typeof asked.rarity === 'string' && asked.rarity && asked.rarity !== input.rarity) {
      notes.push(`No module rarity named "${asked.rarity}"; used ${input.rarity} instead.`)
    }
    if (typeof asked.targetLevel === 'number' && asked.targetLevel > levelCap) {
