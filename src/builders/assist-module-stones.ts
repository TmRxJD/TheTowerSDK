 ...
 */
/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    assistModuleStonesCalculator
 * depends    src/builders/types, src/data, src/mechanics
 * used by    src/builders/index
 * ─────────────────────────────────────────────── generated by `npm run map` ──
 */
import { ASSIST_MODULE_STONE_COSTS } from '../data'
import { cumulativeAssistStoneCost } from '../mechanics'
import { type CalculatorBuilder, type CalculatorResultBase, clampNumber ,
  safeRecord} from './types'
import type { AssistModuleStonesInput, AssistModuleStonesResult } from './types'
...
> = {
  ...
  compute(rawInput = {}) {
    ...
    if (typeof asked.targetLevel === 'number' && asked.targetLevel > MAX_LEVEL) {
