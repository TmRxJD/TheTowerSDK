 ...
 */
/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    labResearchCalculator
 * depends    src/builders/types, src/data, src/formatting
 * used by    src/builders/index
 * ─────────────────────────────────────────────── generated by `npm run map` ──
 */
import { LAB_CATALOG, type LabCatalogRecord } from '../data'
...
import type { LabResearchInput, LabResearchLevel, LabResearchResult } from './types'
