 ...
 * depends    —
 * used by    src/mechanics/calculators/specs-generated, src/save/battle/index, src/save/battle/report-fields, src/save/battle/reports
...
/** Formats seconds into `XhYmZs` duration strings. */
