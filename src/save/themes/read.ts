 ...
 * used by    src/mechanics/calculators/specs-generated, src/save/index, src/save/relics/read, src/save/themes/index
...
/** Theme names as used by the `collectedThemes` map (catalog label). */
