 ...
 * depends    src/data/labs, src/data/labs-display-overrides, src/data/labs-research, src/data/player-stats, src/internal/labs-persistence, src/save/favorite-labs (+2 more)
