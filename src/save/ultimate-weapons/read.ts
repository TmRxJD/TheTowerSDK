/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    UltimateWeaponStatLevel, UltimateWeaponStat, UltimateWeaponData, UW_SAVE_BASE_STAT_LEVELS_PER_SLOT, UW_SAVE_SYSTEM_UNLOCKED_KEY, UW_SAVE_WEAPON_LEVEL_KEY, UW_SAVE_WEAPON_UNLOCKED_KEY, UW_SAVE_WEAPON_ON_KEY (+22 more)
 * depends    src/data/ultimate-weapons/stones, src/data/ultimate-weapons/ultimate-weapons, src/save/access/values, src/save/catalogs/indexes, src/save/catalogs/ultimate-weapons
 * used by    src/mechanics/calculators/specs-generated, src/save/effective-paths/from-save, src/save/import/counts, src/save/import/planner, src/save/index, src/save/ultimate-weapons/index
 * ─────────────────────────────────────────────── generated by `npm run map` ──
 */
import { IMPORT_CATALOG_META } from '../catalogs/indexes'
import { findUwWeaponByName, type UwWeaponValue } from '../../data/ultimate-weapons/ultimate-weapons'
...
export interface UltimateWeaponsSaveImportPayload {
...
/** Stone-chart catalog for when weapon metadata has not been hydrated yet. */
...
export function canImportUltimateWeapons(extract: UltimateWeaponsSaveExtract | null): boolean {
...
export function buildUltimateWeaponsImportPayload(
  extract: UltimateWeaponsSaveExtract,
  weapons: UltimateWeaponData[],
): UltimateWeaponsSaveImportPayload | null {
