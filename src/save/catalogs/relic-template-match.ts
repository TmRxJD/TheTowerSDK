/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    buildRelicTierSuffixKey, normalizeRelicMatchKey, buildRelicTemplateIdLookup, findRelicTemplateIdFromSaveIndex
 * depends    src/data/relics/data, src/save/catalogs/relics
 * used by    src/mechanics/calculators/specs-generated, src/save/catalogs/index, src/save/relics/read
 * ─────────────────────────────────────────────── generated by `npm run map` ──
 */
import type { RelicTemplate } from '../../data/relics/data'
...
/** Template names that diverge from save catalog roman tier labels. */
...
function readTierFromRequirement(template: RelicTemplate): number | null {
...
/** Normalize relic names for save catalog ↔ template matching. */
...
export function buildRelicTemplateIdLookup(
  ...
  for (const template of templates) {
    ...
    const requirementTier = readTierFromRequirement(template)
