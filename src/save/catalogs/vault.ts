/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    VaultNodeSaveBinding, buildVaultChartSlotIndexById, applyVaultSlotIndexOverrides, buildVaultNodeSlotBindings, POWER_VAULT_SLOT_BINDINGS, HARMONY_VAULT_SLOT_BINDINGS
...
export interface VaultNodeSaveBinding {
  saveIndex: number
  id: string
  name: string
}
...
export function buildVaultNodeSlotBindings(
  nodes: readonly VaultTreeNode[],
  saveIndexById: Record<string, number>,
): VaultNodeSaveBinding[] {
...
export const POWER_VAULT_SLOT_BINDINGS = buildVaultNodeSlotBindings(
  powerTreeNodes,
...
export const HARMONY_VAULT_SLOT_BINDINGS = buildVaultNodeSlotBindings(
  harmonyTreeNodes,
  applyVaultSlotIndexOverrides(
