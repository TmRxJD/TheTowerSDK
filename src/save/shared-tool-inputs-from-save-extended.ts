/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    DISSONANCE_BOOST_SAVE_FIELD_BY_TYPE, DissonanceCycleLayout, readWorkshopLevelByTrackerKey, readWorkshopEnhancementLevelByTrackerKey, mapModuleSaveRarityEnum, readResearchLabLevelsFromSaveRoot, readWorkshopStatLevelsFromSaveRoot, readVaultLevelsFromSaveRoot (+25 more)
 * depends    src/data/campaign-tier, src/data/cards, src/data/labs-display-overrides, src/data/labs-research, src/data/module-levels, src/data/player-stats (+16 more)
 * used by    src/mechanics/calculators/specs-generated, src/save/dissonance, src/save/index, src/save/shared-tool-inputs-from-save
