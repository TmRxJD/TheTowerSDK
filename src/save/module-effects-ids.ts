 ...
 * depends    src/data/module-substats, src/data/modules, src/save/module-effects-decode, src/save/module-effects-registry
 * used by    src/mechanics/calculators/specs-generated, src/save/index, src/save/modules
