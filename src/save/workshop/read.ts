/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    WORKSHOP_SAVE_ATTACK_LEVELS_KEY, WORKSHOP_SAVE_DEFENSE_LEVELS_KEY, WORKSHOP_SAVE_UTILITY_LEVELS_KEY, WORKSHOP_SAVE_ATTACK_ENHANCEMENT_LEVELS_KEY, WORKSHOP_SAVE_DEFENSE_ENHANCEMENT_LEVELS_KEY, WORKSHOP_SAVE_UTILITY_ENHANCEMENT_LEVELS_KEY, WORKSHOP_SAVE_PRESET_ATTACK_LEVELS_KEY, WORKSHOP_SAVE_PRESET_DEFENSE_LEVELS_KEY (+28 more)
 * depends    src/data/workshop/enhancement-progress-definitions, src/data/workshop/progress-definitions, src/save/access/values
 * used by    src/mechanics/calculators/specs-generated, src/save/bots/read, src/save/effective-paths/from-save, src/save/import/counts, src/save/import/planner, src/save/index (+2 more)
...
import { getWorkshopStatDefinitions, type WorkshopCategory } from '../../data/workshop/progress-definitions'
...
export interface WorkshopSaveImportPayload {
  levels: Record<string, number>
  enhancementLevels: Record<string, number>
  presets?: Array<{
    name?: string
...
export function buildWorkshopImportPayload(parsedRoot: unknown): WorkshopSaveImportPayload | null {
