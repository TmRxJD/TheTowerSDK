 ...
 * depends    src/data/relics, src/save/catalogs/indexes, src/save/catalogs/relic-template-match, src/save/catalogs/relics, src/save/read-values, src/save/themes (+1 more)
