 ...
 *
 * The paths read almost everything from the targets, which the save import
 ...
 * the game is running.
 *
 * Those are not stored progress and have nowhere to live, so they are
 ...
 * depends    src/save/access/values
