 ...
 * depends    src/data/module-effect-resolver, src/data/module-substats, src/save/module-effects-display, src/save/module-effects-registry
 * used by    src/mechanics/calculators/specs-generated, src/save/index, src/save/module-effects-ids, src/save/shared-tool-inputs-from-save, src/save/shared-tool-inputs-from-save-extended
