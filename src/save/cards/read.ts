/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    CARDS_SAVE_LEVEL_KEY, CARDS_SAVE_COUNT_KEY, CARDS_SAVE_UNLOCKED_KEY, CARDS_SAVE_ACTIVE_KEY, CARDS_SAVE_MASTERY_UNLOCKED_KEY, CARDS_SAVE_SLOTS_UNLOCKED_KEY, CARDS_SAVE_BOUGHT_TOTAL_KEY, CARDS_SAVE_CURRENT_PRESET_KEY (+17 more)
 * depends    src/data/assets/data, src/data/cards/data, src/data/player-stats/data, src/save/access/values
 * used by    src/mechanics/calculators/specs-generated, src/save/cards/index, src/save/ids/import-blocks, src/save/ids/import-collections, src/save/ids/import-domains, src/save/ids/import-progression (+4 more)
 * ─────────────────────────────────────────────── generated by `npm run map` ──
 */
import { CARD_MAX_COPIES, CARD_TEMPLATES } from '../../data/cards/data'
import { CARD_IMPORT_CATALOG } from '../../data/player-stats/data'
import { CARDS_ASSET_TABLE } from '../../data/assets/data'
...
export interface CardsSaveImportPayload {
  entries: Array<{
    cardId: string
    level: number
    mastery: number
...
export function buildCardsImportPayload(extract: CardsSaveExtract): CardsSaveImportPayload | null {
  const entries: CardsSaveImportPayload['entries'] = []
