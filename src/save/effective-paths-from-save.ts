 ...
 * depends    src/data/bots, src/data/workshop-enhancement-tracker-definitions, src/mechanics/effective-paths-eecon-compute, src/mechanics/effective-paths-eecon-levels, src/mechanics/effective-paths-eecon-plan, src/save/bots (+4 more)
