 ...
 * depends    src/save/catalogs/perks, src/save/read-values
 * used by    src/internal/shared-tool-inputs, src/mechanics/calculators/specs-generated, src/save/index, src/save/shared-tool-inputs-from-save
