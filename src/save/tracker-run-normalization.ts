/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    RunDataRecordLike, TrackerCanonicalRunData, canonicalizeTrackerRunData, serializeTrackerRunForCloudAttributes, getFirstMeaningfulRunDataValue, applyRunDataAliasGroups, normalizeGuardianSummonedEnemies, dedupeEquivalentRunDataKeys (+1 more)
 * depends    src/formatting/index, src/internal/tracker-run-field-vocabulary
 * used by    src/mechanics/calculators/run, src/mechanics/calculators/specs-generated, src/save/index
