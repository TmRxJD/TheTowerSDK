 ...
 * depends    src/data/bots, src/data/labs, src/data/module-levels, src/formatting/numbers, src/internal/shared-tool-inputs, src/internal/shared-tool-inputs-from-research (+10 more)
