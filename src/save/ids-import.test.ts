 ...
 * sheet's IDS still fills the site's trackers, so the fixture has to contain
...
describe('resolveIdsLabSaveIndex', () => {
  ...
  it('does not route through LAB_RESEARCH_LEGACY_LEVEL_KEYS, whose targets do not exist', () => {
