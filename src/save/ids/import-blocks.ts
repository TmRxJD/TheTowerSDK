 ...
 * depends    src/data/assets/data, src/data/player-stats/data, src/data/workshop/enhancement-progress-definitions, src/data/workshop/progress-definitions, src/save/cards/read, src/save/catalogs/guardians (+6 more)
 ...
 * `¢ Level` columns are the workshop coin levels; the `$ Level`
