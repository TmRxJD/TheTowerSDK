 ...
 * depends    src/data/assets/data, src/data/player-stats/data, src/data/workshop/enhancement-progress-definitions, src/data/workshop/progress-definitions, src/save/cards/read, src/save/catalogs/guardians (+9 more)
 * used by    src/mechanics/calculators/specs-generated, src/save/ids/index
 ...
 * the exact array a consumer reads. This is the guarantee underneath them --
 * that a value the adapters do NOT model still has somewhere to live, instead
 * of being dropped because nothing has a store for it yet.
 *
 * It matters most for the blocks nothing models at all. `Perks Preset` holds a
 ...
 * written anywhere else, and they are here too, so the raw value survives either
 * way.
 *
 ...
 * caller to store or adapt to, rather than being forced into an array it has
 * no data for.
 */
