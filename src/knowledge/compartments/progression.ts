 ...
 * depends    src/data/battle-condition-names, src/data/generated/index, src/data/milestone-unlocks, src/data/relics, src/data/tiers, src/knowledge/substrate/schema
