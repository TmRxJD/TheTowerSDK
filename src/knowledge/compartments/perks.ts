 ...
 */
/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    PERK_POOL_WEIGHTS, PERK_POOL_WEIGHTS_FROM_GAME_CONSTANTS, PERK_WAVES_REQUIRED_BY_COUNT, PERK_WAVE_REQUIREMENT_ORDER, STANDARD_PERK_MAX_QUANTITY, PERK_CONSUMER_METHODS, PERKS_APPLIED_TO_ENEMY_BASE, PERK_CONSUMER_METHOD_COUNT (+2 more)
 * depends    src/data/perks/data, src/knowledge/substrate/schema, src/mechanics/perks/benefit, src/save/catalogs/perks
 * used by    src/knowledge/compartments/index, src/knowledge/index
 * ─────────────────────────────────────────────── generated by `npm run map` ──
 */
import { PERK_POOL_MAP, PERK_POOL_RATES, STANDARD_PERKS, TRADE_OFF_PERKS, UW_PERKS } from '../../data/perks/data'
import {
  PERK_44_IS_A_FLAG,
