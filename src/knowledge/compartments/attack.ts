 ...
 */
/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    PROJECTILE_WORKSHOP_MAXIMA, ATTACK_STAT_GAME_NAMES, ATTACK_STAT_NAME_DISAGREEMENTS, ATTACK_ENTRIES_NOT_TOWER_STATS, ATTACK_STAT_RECOMPUTE_INDEX, ATTACK_BLOCK_LAST_INDEX, ATTACK_KNOWLEDGE_NODES, ATTACK_KNOWLEDGE_EDGES
 * depends    src/data/player-stats/recompute-order, src/knowledge/substrate/schema
...
const WIKI_BOUNCE_SHOT = {
  origin: 'wiki',
  ref: 'Bounce Shot',
  note: 'game-vault.net; the Fandom page is an empty stub',
