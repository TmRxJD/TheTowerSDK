 ...
 */
/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    ELITE_SPAWN_CHANCE_TIER_RATIO, ELITE_SPAWN_CHANCE_TIER_BLOCKS, eliteSpawnSinglePercentAtRow, eliteSpawnDoublePercentAtRow, ELITE_SPAWN_CHANCE_MISSING_CELLS, ENEMY_SPAWN_CAP, ENEMY_BASE_COIN_VALUE, ENEMY_HEALTH_MULTIPLE (+48 more)
 * depends    src/data/enemies/data, src/knowledge/substrate/schema, src/mechanics/enemies/type-mix, src/mechanics/resource-drops/coin-simulation, src/mechanics/waves/reference/base-constants
 * used by    src/knowledge/compartments/index, src/knowledge/index, src/mechanics/calculators/specs-generated
 * ─────────────────────────────────────────────── generated by `npm run map` ──
 */
import { measuredAverageEnemyCoinWeight } from '../../mechanics/enemies/type-mix'
import { RESOURCE_DROPS_AVG_ENEMY_COIN_WEIGHT } from '../../mechanics/resource-drops/coin-simulation'
import { WAVE_FORMULA } from '../../mechanics/waves/reference/base-constants'
import { ENEMY_TYPE_SUMMARIES } from '../../data/enemies/data'
