 ...
 * depends    src/data/enemies, src/knowledge/substrate/schema, src/mechanics/enemy-type-mix, src/mechanics/resource-drops-coin-simulation, src/mechanics/wave/_reference/wave-base-constants
