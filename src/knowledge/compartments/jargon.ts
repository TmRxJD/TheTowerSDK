/**
 * Community jargon — terms players use that are not game mechanics.
 *
 ...
 * depends    src/data/glossary/glossary, src/knowledge/compartments/build-targets, src/knowledge/substrate/schema
 * used by    src/knowledge/compartments/index, src/knowledge/index
 * ─────────────────────────────────────────────── generated by `npm run map` ──
 */
import { expandAcronym, GLOSSARY, listAmbiguousGlossaryTerms } from '../../data/glossary/glossary'
import { BUILD_TARGET_GRAMMAR } from './build-targets'
import type { KnowledgeEdge, KnowledgeNode } from '../substrate/schema'

const COMMUNITY = {
  origin: 'user',
  ref: 'community vocabulary',
