 ...
 */
/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    ULTIMATE_WEAPON_STONE_COST, ULTIMATE_WEAPON_TOTAL_STONE_COST, ULTIMATE_WEAPON_STATS, ULTIMATE_WEAPONS_WITHOUT_COOLDOWN, ULTIMATE_WEAPON_STAT_NAME_MAP, ULTIMATE_WEAPON_PLUS_STAT, ULTIMATE_WEAPON_CATALOG_ASSERTIONS, ULTIMATE_WEAPON_STONES_TO_MAX_ALL (+5 more)
 * depends    src/data/ultimate-weapons/stones, src/knowledge/substrate/schema
 * used by    src/knowledge/compartments/build-targets, src/knowledge/compartments/index, src/knowledge/compartments/uw-plus, src/knowledge/index
