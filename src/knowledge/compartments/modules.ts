 ...
 */
/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    MODULE_RARITY_MAX_LEVEL, MODULE_PULL_CHANCE_PERCENT, SUB_MODULE_SLOT_LEVELS, ASSIST_STONE_COST_BY_PURCHASE, ASSIST_STONE_COST_PER_TYPE, ASSIST_STONE_COST_ALL_TYPES, ASSIST_STONE_COST_UNLOCK_AND_UNIQUE_PER_TYPE, ASSIST_STONE_COST_UNLOCK_AND_UNIQUE_ALL_TYPES (+16 more)
 * depends    src/data/modules/costs, src/data/modules/levels, src/data/modules/modules, src/knowledge/substrate/schema
 * used by    src/knowledge/compartments/index, src/knowledge/index
 * ─────────────────────────────────────────────── generated by `npm run map` ──
 */
import { UNIQUE_MODULE_TEMPLATES } from '../../data/modules/modules'
import { ABSOLUTE_MAX_MODULE_LEVEL, MODULE_RARITIES } from '../../data/modules/levels'
import { MODULE_REROLL_COSTS_BY_LOCKED_SUBSTATS } from '../../data/modules/costs'
...
export const UNIQUE_MODULE_NAMES_BY_TYPE: Readonly<Record<string, readonly string[]>> = {
  Cannon: [
    ...
    'Shrink Ray', 'Amplifying Strike', 'Acceleration Augment', 'Tactical Barrage',
  ],
  Armor: [
    'Anti-Cube Portal', 'Negative Mass Projector', 'Wormhole Redirector',
    'Space Displacer', 'Sharp Fortitude', 'Orbital Augment', 'Sentry Protocol',
  ],
  Generator: [
    'Singularity Harness', 'Galaxy Compressor', 'Pulsar Harvester',
    'Black Hole Digestor', 'Project Funding', 'Restorative Bonus', 'Gilded Sniper',
  ],
  Core: [
...
export const MODULE_KNOWLEDGE_NODES: readonly KnowledgeNode[] = [
  ...
  },
  {
    ...
    implementedBy: ['ASSIST_MODULE_STONE_COSTS', 'MODULE_TYPE_ROWS'],
    traps: [
