 ...
 */
/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    LAB_RESEARCH_SLOT_COUNT, LAB_NAMED_RESEARCH_COUNT, LAB_UNNAMED_SLOT_RUNS, FLEET_LAB_INDICES, LAB_SLOT_GEM_COST, LAB_MAX_SLOTS, LAB_BOOST_BASE_CELL_COST_1H, LAB_BOOST_COST_STEP_PER_BOOSTED_LAB (+4 more)
...
const GAMEVAULT_LABS = {
  origin: 'wiki',
  ref: 'Lab',
  note: 'game-vault.net; the full boost cost table, which Fandom has no equivalent of',
