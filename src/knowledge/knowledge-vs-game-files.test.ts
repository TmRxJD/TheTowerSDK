...
import { TIER_BATTLE_CONDITION_DEFINITIONS, TIER_BATTLE_CONDITION_TIERS } from '../data/index'
import { BATTLE_CONDITION_ULTIMATE_NAMES, KNOWN_WRONG_NAMES } from './compartments/naming'
