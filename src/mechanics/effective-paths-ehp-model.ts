 ...
 * depends    src/data/module-bonus, src/mechanics/effective-paths-hp, src/mechanics/effective-paths-workshop-values
 * used by    src/mechanics/calculators/specs-generated, src/mechanics/effective-paths-edamage-compute, src/mechanics/effective-paths-eecon-compute, src/mechanics/effective-paths-ehp-from-sheet, src/mechanics/effective-paths-ehp-plan, src/mechanics/effective-paths-levels-schema (+2 more)
