/**
 * Card level / mastery effect lookup — values from `card-data.ts`.
 */
/* ── file map ─────────────────────────────────────────────────────────────────
 ...
 * depends    src/data, src/mechanics/enemies/drops-context
 * used by    src/mechanics/calculators/specs-generated, src/mechanics/cards/index, src/mechanics/enemies/elite-spawn-chance
 * ─────────────────────────────────────────────── generated by `npm run map` ──
 */
import { CARD_TEMPLATE_MAP } from '../../data'
import { clampCardGameLevel, clampCardMasteryLevel } from '../enemies/drops-context'
