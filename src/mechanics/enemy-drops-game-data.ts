 ...
 */
/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    MODULE_DROP_LAB_MULT, COMMON_MODULE_DROP_BASE, RARE_MODULE_DROP_BASE, BOSS_REROLL_SHARDS_PROC, REROLL_SHARDS_BY_TIER, ModuleShatterRarity, ResolvedEnemyDropsLabs, getCommonModuleDropChance (+9 more)
 * depends    src/data/index, src/mechanics/math
 * used by    src/mechanics/calculators/specs-generated, src/mechanics/enemy-drops-simulation, src/mechanics/index, src/mechanics/resource-drops-coin-fetch
