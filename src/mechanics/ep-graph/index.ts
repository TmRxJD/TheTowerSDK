/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    loadEpGraph, filterEpGraph, applyEpGraphMutations, validateEpGraph, renderEpGraphMermaidSlices, buildEpGraphIndex, formatEpGraphStatusReport, renderEpRelationsNarrative
 * depends    src/mechanics/ep-graph/build-index, src/mechanics/ep-graph/data/ep-graph.v1.json, src/mechanics/ep-graph/mutate, src/mechanics/ep-graph/narrative, src/mechanics/ep-graph/render-mermaid, src/mechanics/ep-graph/schema (+1 more)
 * used by    —
