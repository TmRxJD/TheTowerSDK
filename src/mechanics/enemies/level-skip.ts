 ...
 */
/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    ATTACK_LEVEL_SKIP_UTILITY_INDEX, HEALTH_LEVEL_SKIP_UTILITY_INDEX, ATTACK_LEVEL_SKIP_MODULE_CLUSTER_INDEX, HEALTH_LEVEL_SKIP_MODULE_CLUSTER_INDEX, ATTACK_LEVEL_SKIP_MODULE_INDEX, HEALTH_LEVEL_SKIP_MODULE_INDEX, LAB_ENEMY_ATTACK_LEVEL_SKIP, LAB_ENEMY_HEALTH_LEVEL_SKIP (+50 more)
 * depends    src/data/workshop/table.json, src/mechanics/battle-conditions/conditions, src/mechanics/enemies/wave-stats, src/mechanics/primitives/constants, src/mechanics/primitives/math, src/support/own-lookup
 * used by    src/data/workshop/progress-definitions, src/mechanics/calculators/specs-generated, src/mechanics/enemies/index, src/mechanics/enemies/stats-simplified, src/mechanics/enemies/wave-panel, src/mechanics/labs/bc-counter-labs (+2 more)
 * ─────────────────────────────────────────────── generated by `npm run map` ──
 */

import { ownLookup } from '../../support/own-lookup'
import workshopData from '../../data/workshop/table.json'
import { LEVEL_SKIP_WAVE_POW_BASE } from '../primitives/constants'
import { clamp, safeMul } from '../primitives/math'
import { waveBands } from './wave-stats'
import {
  applySkipDecay,
...
} from '../battle-conditions/conditions'
