 ...
 */
/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    EnemyWaveEnemyType, EnemyWaveBaseStats, EnemyWaveStats, ENEMY_MULT_BY_TYPE, EnemyWaveScalingContext, getBasicEnemyWaveStats, getWaveBaseStats, getEnemyWaveStats (+1 more)
 * depends    src/data/tiers/campaign, src/mechanics/enemies/type-mults, src/mechanics/waves/base-scaling
 * used by    src/internal/local-state/enemy-stats-calcs, src/mechanics/calculators/specs-generated, src/mechanics/enemies/index, src/mechanics/enemies/level-skip, src/mechanics/enemies/stat-display, src/mechanics/enemies/stats-simplified (+5 more)
...
} from '../waves/base-scaling'
import { ENEMY_MULT_BY_TYPE_TABLE } from './type-mults'

export type EnemyWaveEnemyType = keyof typeof ENEMY_MULT_BY_TYPE_TABLE
...
export const ENEMY_MULT_BY_TYPE = ENEMY_MULT_BY_TYPE_TABLE
...
export function getEnemyWaveStats(
  ...
  const input = resolveWaveInput(tier, wave, context)
  const typeMult = ENEMY_MULT_BY_TYPE[enemyType]
