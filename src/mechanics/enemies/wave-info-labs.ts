 ...
 */
/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    WAVE_INFO_ENEMY_LAB_HP_OFFSETS, WAVE_INFO_ENEMY_LAB_DAMAGE_OFFSETS, WAVE_INFO_ENEMY_LAB_SLUG_BY_TYPE, computeEnemyLabLevelFromMap, enemyLabSlugForWorkshopOffset, waveInfoEnemyLabSlugForRow, waveInfoEnemyLabMultiplierForRow, waveInfoWorkshopOffsetForType (+2 more)
 * depends    src/mechanics/battle-conditions/config, src/mechanics/enemies/wave-stats, src/mechanics/waves/info-enemy-constants, src/support/own-lookup
 * used by    src/mechanics/calculators/specs-generated, src/mechanics/enemies/index, src/mechanics/enemies/wave-info-pipeline, src/mechanics/enemies/wave-panel, src/mechanics/waves/info-enemy-stats
 * ─────────────────────────────────────────────── generated by `npm run map` ──
 */
import { ownLookup } from '../../support/own-lookup'
import type { EnemyWaveEnemyType } from './wave-stats'
import { workshopMultFromTableFloat } from '../battle-conditions/config'
import { WAVE_INFO_ENEMY_RULES, WAVE_INFO_WORKSHOP_OFFSETS } from '../waves/info-enemy-constants'
