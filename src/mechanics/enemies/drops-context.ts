/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    computeTierNumber, EnemyDropsCardLevels, EnemyDropsLinkedSources, EnemyDropsRoiEconomyContext, guardianSourceLevelToNormalized, computeWaLevelFromCardLevel, computeWaveTimeSecondsFromUptime, computeWaveTimeSecondsFromWaCard (+9 more)
 * depends    src/data, src/internal/local-state/enemy-drops-calcs, src/internal/persistence/labs-persistence, src/internal/shared-tool-inputs/extended, src/internal/uptime/shared-inputs, src/mechanics/enemies/drops-shared (+1 more)
 * used by    src/mechanics/calculators/specs-generated, src/mechanics/cards/effect-lookup, src/mechanics/enemies/drops-simulation, src/mechanics/enemies/index, src/mechanics/resource-drops/coin-context
 * ─────────────────────────────────────────────── generated by `npm run map` ──
 */
import { clampCampaignTier } from '../../data'
import { buildGuardianDefinitions } from '../../data'
import { guardianUpgrades } from '../../data'
import { findLabResearchBySlug } from '../../data'
import { type LabProgressModifiers } from '../../data'
import { computeResearchLabLevel } from '../../data'
import type { SharedEnemyDropsInputs } from '../../internal/local-state/enemy-drops-calcs'
import type { SharedLabsSettings } from '../../internal/persistence/labs-persistence'
import type {
  SharedEnemyStatsCore,
  SharedLabsCalcByLab,
  SharedWorkshopStatLevels,
} from '../../internal/shared-tool-inputs/extended'
import type { SharedUptimeInputs } from '../../internal/uptime/shared-inputs'
import { getUptimeCoreStateFromSharedInputs } from '../../internal/uptime/shared-inputs'
import {
...
// clampCardGameLevel / clampCardMasteryLevel now live in ./drops-shared (leaf);
// re-exported (imported above for local use) for external consumers.
export { clampCardGameLevel, clampCardMasteryLevel }
