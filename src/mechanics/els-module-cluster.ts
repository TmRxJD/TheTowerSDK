 ...
 * depends    src/mechanics/enemy-level-skip
 * used by    src/internal/enemy-stats-calcs-local-state, src/internal/game-input-data/els-dropdown-math, src/internal/shared-tool-inputs-field-sync, src/mechanics/calculators/specs-generated, src/mechanics/els-calculator-options, src/mechanics/els-upgrade-path (+2 more)
