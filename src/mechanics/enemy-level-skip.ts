 ...
 * depends    src/data/workshop.json, src/internal/own-lookup, src/mechanics/battle-conditions, src/mechanics/constants, src/mechanics/enemy-wave-stats, src/mechanics/math
 * used by    src/data/workshop-tracker-definitions, src/mechanics/bc-counter-labs, src/mechanics/calculators/specs-generated, src/mechanics/els-module-cluster, src/mechanics/els-upgrade-path, src/mechanics/enemy-stats-simplified (+1 more)
