 ...
 * depends    —
 * used by    src/mechanics/battle-condition-config, src/mechanics/bc-counter-labs, src/mechanics/calculators/specs-generated, src/mechanics/enemy-level-skip, src/mechanics/index
