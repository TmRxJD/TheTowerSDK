 ...
 * depends    src/data/ultimate-weapon-stones, src/internal/own-lookup
 * used by    src/internal/game-input-data/index, src/internal/game-input-data/uw-game-input-keys, src/internal/game-input-data/uw-stat-dropdown-math, src/mechanics/calculators/specs-generated, src/mechanics/index, src/mechanics/resource-drops-coin-simulation (+1 more)
