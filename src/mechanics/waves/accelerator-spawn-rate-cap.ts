 ...
 */
/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    WaveAcceleratorSpawnRateCapInput, waveAcceleratorSpawnMasteryBonusPercent, findWaveAcceleratorMasteryForSpawnCap, waveAcceleratorSpawnRateChartColumn, enemySpawnRateCapFromWaveAcceleratorChart
 * depends    src/data/charts/data
 * used by    src/mechanics/calculators/specs-generated, src/mechanics/resource-drops/coin-multipliers, src/mechanics/resource-drops/coin-simulation, src/mechanics/resource-drops/simulate-wave-coins, src/mechanics/resource-drops/simulate-wave-econ, src/mechanics/waves/index (+3 more)
...
/**
 * Card mastery → chart column input.
