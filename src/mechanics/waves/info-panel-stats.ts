 ...
 */
/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    WaveInfoPanelStatsInput, WaveInfoPanelSummary, WaveInfoPanelEnemyExtras, protectorRadiusGrowthFactor, enemyMassWaveMult, enemySpeedWaveMult, waveInfoEnemySpeed, waveInfoEnemyMass (+13 more)
 * depends    src/data, src/mechanics/battle-conditions/config, src/mechanics/enemies/elite-spawn-chance, src/mechanics/enemies/wave-stats, src/mechanics/waves/accelerator-spawn-rate-cap, src/mechanics/waves/info-panel-constants (+1 more)
 * used by    src/mechanics/calculators/specs-generated, src/mechanics/enemies/wave-panel, src/mechanics/waves/index, src/mechanics/waves/spawn-type-chances-coin-mix
 * ─────────────────────────────────────────────── generated by `npm run map` ──
 */
import type { EnemyWaveEnemyType } from '../enemies/wave-stats'
...
} from './accelerator-spawn-rate-cap'
import {
  type WaveInfoPanelTimingInput,
  waveInfoPanelWaveCooldownSeconds,
  waveInfoPanelWaveTimeSeconds,
} from './info-panel-timing'

const F32 = Math.fround

export type { WaveAcceleratorSpawnRateCapInput } from './accelerator-spawn-rate-cap'
export {
  enemySpawnRateCapFromWaveAcceleratorChart,
...
export type WaveInfoPanelStatsInput = {
  ...
  /** Enemy Balance mastery 0–9 — double-elite spawn chance only. */
