/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    WAVE_INFO_WORKSHOP_SCALE, WAVE_INFO_RESISTANCE_HP_FLOAT_PER_LEVEL, WAVE_INFO_RESISTANCE_DAMAGE_FLOAT_PER_LEVEL, WAVE_INFO_PROTECTOR_HP_MULT, WAVE_INFO_BOSS_OVERHEAL_WAVE_THRESHOLDS, WAVE_INFO_BOSS_OVERHEAL_MULTS, WAVE_INFO_OVERCHARGE_DAMAGE_MULT, WAVE_INFO_VAMPIRE_TOWER_DAMAGE_MULT (+2 more)
 * depends    —
 * used by    src/mechanics/battle-conditions/config, src/mechanics/enemies/wave-info-labs, src/mechanics/waves/index, src/mechanics/waves/info-enemy-stats
