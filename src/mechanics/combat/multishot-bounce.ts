 ...
 * depends    src/mechanics/combat/distances, src/mechanics/primitives/constants, src/support/own-lookup
...
import { BOUNCE_ANGLE_HALF_CIRCLE, BOUNCE_DISTANCE_EPSILON } from '../primitives/constants'
