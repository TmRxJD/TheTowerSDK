 ...
 */
/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    IMPLEMENTED_CALCULATOR_IDS, CalculatorResult, CalculatorError, runCalculator, listCalculators
 * depends    src/data/bots/data, src/data/enemies/data, src/data/guardians/guardians, src/data/labs/labs, src/data/modules/bonus, src/data/modules/levels (+23 more)
 * used by    src/mechanics/calculators/index
 * ─────────────────────────────────────────────── generated by `npm run map` ──
 */

import { bossWaveIntervalForTier } from '../../data/enemies/data'
import { computeModuleStat, normalizeModuleTypeForCalc } from '../../data/modules/bonus'
import {
...
import { eliteSpawnChanceAtWave } from '../enemies/elite-spawn-chance'
import {
  computeChronoFieldReductionPct,
  damageTakenMultiplierFromReductionPct,
} from '../combat/damage-redux-layers'
import {
  computeInnerLandMinesCooldownSeconds,
  computeInnerLandMinesQuantity,
} from '../modules/ilm-charge'
import { abilityDamage } from '../combat/damage'
import { collectRunScalarFields } from '../../save/runs/fields'
import { getFirstMeaningfulRunDataValue } from '../../save/runs/normalization'
import {
  ELS_WORKSHOP_ATTACK_LEVEL_OPTIONS,
  ELS_WORKSHOP_HEALTH_LEVEL_OPTIONS,
} from '../modules/els-calculator-options'
import {
  damageWave100Multiplier,
  healthWave100Multiplier,
} from '../waves/base-empirical-scaling' 
...
import { computeInnerLandMinesDamageMult } from '../modules/ilm-charge'
import { formatDuration } from '../../formatting/duration/compute'
import {
  computeHourlyRate,
...
} from '../../formatting/numbers/compute'
...
const CURATED_IMPLEMENTATIONS: Record<string, (args: Record<string, unknown>) => unknown> = {
  ...
  'lab.uiMaxLevel': a => getLabMaxLevel(a.lab as never),
  ...
  'lab.isResearchName': a => isLabsResearchLabName(a.name as string | undefined),
  ...
  'run.collectScalarFields': a => collectRunScalarFields(...(a.sources as never[])),
