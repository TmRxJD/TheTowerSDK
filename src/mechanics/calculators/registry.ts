 ...
 */
/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    EPATHS_CALCULATORS, CALCULATORS, CALCULATOR_IDS, calculatorSpec
 * depends    src/mechanics/calculators/specs-catalog, src/mechanics/calculators/specs-formatting, src/mechanics/calculators/specs-generated, src/mechanics/calculators/specs-irregular, src/mechanics/calculators/specs-progress, src/mechanics/calculators/types
 * used by    src/mechanics/calculators/graph, src/mechanics/calculators/index, src/mechanics/calculators/run
...
import { PROGRESS_CALCULATORS } from './specs-progress'
...
export const EPATHS_CALCULATORS: readonly CalculatorSpec[] = [
  ...
  // ------------------------------------------------------------- modules ---
  {
    ...
    entry: 'data',
    module: 'packages/sdk/src/data/modules/bonus.ts',
  ...
  // -------------------------------------------------------------- enemies ---
  {
    ...
    entry: 'data',
    module: 'packages/sdk/src/data/enemies/data.ts',
  ...
  },
  {
    ...
    entry: 'mechanics',
    module: `${MECH}/enemies/elite-spawn-chance.ts`,
