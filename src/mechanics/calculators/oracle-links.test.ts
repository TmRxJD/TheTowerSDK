...
import { CALCULATOR_ORACLE_LINKS } from './oracle-links'
import { CALCULATORS } from './registry'
import { GAME_KNOWLEDGE, knowledgeFor, trapsFor } from '../../knowledge'
...
describe('what the link is for', () => {
  ...
  it('links a meaningful share of the curated tier', () => {
    ...
    // 51 of 83. The rest are the formatting layer and the input plumbing, which
    // is most of what is left once the game mechanics are linked.
    expect(curated).toHaveLength(83)
