...
import { CoverageInventorySchema, findSilentGaps } from './schema'
import sheetsRaw from './data/sheets.v1.json'
import { distinctEpPlannerCellKeys } from './ep-citations'
...
describe('mechanics coverage + trust', () => {
  it('sheets inventory has zero silent gaps', () => {
    ...
    expect(inv.entries.length).toBe(157)
  })
