 ...
 * depends    src/data/tiers, src/data/tournaments, src/mechanics/battle-conditions, src/mechanics/tournament-heat-bc, src/mechanics/wave-info-enemy-constants
 * used by    src/internal/enemy-stats-calcs-local-state, src/internal/game-input-data/research-lab-dropdown-math, src/internal/shared-tool-inputs-extended, src/mechanics/bc-counter-labs, src/mechanics/calculators/specs-generated, src/mechanics/damage-redux-wave-stats (+7 more)
