 ...
 */
/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    EFFECTIVE_PATHS_LAB_KEYS, findEffectivePathsLabKey, LabCostModifiers, labCoinDiscount, labSpeedTotal, labCoinCostToReachLevel, labDurationDaysToReachLevel, labCatalogName (+1 more)
 * depends    src/data/labs-catalog, src/formatting/numbers, src/internal/own-lookup
