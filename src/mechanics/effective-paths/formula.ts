 ...
 */
/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    EffectivePathsFormulaError, ParseSheetFunctionOptions, parseSheetFunction
 * depends    src/mechanics/effective-paths/schema
 * used by    src/mechanics/calculators/specs-generated, src/mechanics/effective-paths/index, src/mechanics/effective-paths/workbook
 * ─────────────────────────────────────────────── generated by `npm run map` ──
 */

import type { EffectivePathsExpr, EffectivePathsStat, EffectivePathsTerm } from './schema'
