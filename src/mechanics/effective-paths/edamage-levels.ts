 ...
 * `EFFECTIVE_DAMAGE_CANDIDATES_BY_PATH`; this is the state those candidates move.
 *
 * Grouped by which path buys it, because almost nothing is bought by two.
 */
/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    EffectiveDamageLabLevels, EffectiveDamageStoneLevels, EffectiveDamageCoinLevels, EffectiveDamageKeysLevels, EffectiveDamageLevels, ZERO_EFFECTIVE_DAMAGE_LEVELS, SHARED_ASSIST_LEVEL_KEYS, SharedAssistLevelKey (+1 more)
 * depends    —
 * used by    src/mechanics/calculators/specs-generated, src/mechanics/effective-paths/edamage-coin-levels, src/mechanics/effective-paths/edamage-compute, src/mechanics/effective-paths/edamage-lab-levels, src/mechanics/effective-paths/edamage-lab-targets, src/mechanics/effective-paths/edamage-plan (+2 more)
