/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    EffectiveDamagePathVariant, EffectiveDamageCandidate, EFFECTIVE_DAMAGE_LAB_CANDIDATES, EFFECTIVE_DAMAGE_STONE_CANDIDATES, EFFECTIVE_DAMAGE_COIN_CANDIDATES, EFFECTIVE_DAMAGE_KEYS_CANDIDATES, EFFECTIVE_DAMAGE_CANDIDATES_BY_PATH
 * depends    —
 * used by    src/mechanics/effective-paths/edamage-lab-targets, src/mechanics/effective-paths/edamage-plan, src/mechanics/effective-paths/index
...
/** `eDamage Coins!GA4:GY4` — the coin path's 25 (v5.10+; FZ is blank spacer). */
export const EFFECTIVE_DAMAGE_COIN_CANDIDATES: readonly EffectiveDamageCandidate[] = [
  { column: 'GA', sheetName: 'Damage +' },
  { column: 'GB', sheetName: 'Damage Mastery' },
  { column: 'GC', sheetName: 'Demon Mode Mastery' },
  { column: 'GD', sheetName: 'Critical Chance Mastery' },
  { column: 'GE', sheetName: 'Critical Factor +' },
  { column: 'GF', sheetName: 'Super Crit Mult +' },
  { column: 'GG', sheetName: 'Cash Bonus +' },
  { column: 'GH', sheetName: 'Attack Speed +' },
  { column: 'GI', sheetName: 'Attack Speed Mastery' },
  { column: 'GJ', sheetName: 'Damage/Meter +' },
  { column: 'GK', sheetName: 'Range Mastery' },
  { column: 'GL', sheetName: 'Super Tower Mastery' },
  { column: 'GM', sheetName: 'Rend Armor +' },
  { column: 'GN', sheetName: 'Ultimate Crit Mastery' },
  { column: 'GO', sheetName: 'Primary Module - Cannon' },
  { column: 'GP', sheetName: 'Assist Module - Cannon' },
  { column: 'GQ', sheetName: 'Primary Module - Core' },
  { column: 'GR', sheetName: 'Assist Module - Core' },
  { column: 'GS', sheetName: 'Assist Module Substats - Cannon' },
  { column: 'GT', sheetName: 'Assist Module Substats - Armor' },
  { column: 'GU', sheetName: 'Assist Module Substats - Core' },
  { column: 'GV', sheetName: 'Assist Module Bonus - Cannon' },
  { column: 'GW', sheetName: 'Assist Module Bonus - Core' },
  { column: 'GX', sheetName: 'Dissonant Echo - Attack' },
  { column: 'GY', sheetName: 'Dissonant Echo - Ultimate Weapons' },
]
...
export const EFFECTIVE_DAMAGE_CANDIDATES_BY_PATH: Readonly<
