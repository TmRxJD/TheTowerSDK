 ...
 */
/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    EffectiveHealthLevels, ZERO_EFFECTIVE_HEALTH_LEVELS, EffectiveHealthStatSource, EffectiveHealthCardSource, EffectiveHealthPerks, NO_EFFECTIVE_HEALTH_PERKS, zeroEffectiveHealthConfig, zeroEffectiveRegenConfigSource (+12 more)
 * depends    src/data/modules/bonus, src/mechanics/effective-paths/hp, src/mechanics/effective-paths/workshop-values
 * used by    src/mechanics/calculators/specs-generated, src/mechanics/effective-paths/edamage-compute, src/mechanics/effective-paths/edamage-plan, src/mechanics/effective-paths/eecon-compute, src/mechanics/effective-paths/ehp-from-sheet, src/mechanics/effective-paths/ehp-plan (+3 more)
 ...
 *
 * A caller building a config from a save or stored progress needs somewhere to start
