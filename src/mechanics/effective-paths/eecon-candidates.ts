/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    EffectiveEconomyPathVariant, EffectiveEconomyCandidate, EFFECTIVE_ECONOMY_TIME_CANDIDATES, EFFECTIVE_ECONOMY_STONE_CANDIDATES, EFFECTIVE_ECONOMY_DISCOUNT_CANDIDATES, EFFECTIVE_ECONOMY_CANDIDATES_BY_PATH, EFFECTIVE_ECONOMY_OUTPUT_CELL_BY_PATH
 * depends    —
 * used by    src/mechanics/effective-paths/eecon-plan, src/mechanics/effective-paths/index
...
export const EFFECTIVE_ECONOMY_CANDIDATES_BY_PATH: Readonly<
 ...
 */
export const EFFECTIVE_ECONOMY_OUTPUT_CELL_BY_PATH: Readonly<
