 ...
 * `EFFECTIVE_ECONOMY_CANDIDATES_BY_PATH`; this is the state those candidates move.
 *
 ...
 */
/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    EffectiveEconomyTimeLevels, EffectiveEconomyStoneLevels, EffectiveEconomyDiscountLevels, EffectiveEconomyLevels, ZERO_EFFECTIVE_ECONOMY_LEVELS, EconomyLevelRef, ECONOMY_TIME_LEVEL_KEYS, ECONOMY_STONE_LEVEL_REFS (+2 more)
 * depends    —
 * used by    src/mechanics/effective-paths/eecon-compute, src/mechanics/effective-paths/eecon-discount, src/mechanics/effective-paths/eecon-plan, src/mechanics/effective-paths/eecon-stone-mastery, src/mechanics/effective-paths/eecon-uw-cd, src/mechanics/effective-paths/index (+2 more)
