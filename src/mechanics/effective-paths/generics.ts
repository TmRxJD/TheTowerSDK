 ...
 * depends    —
 * used by    src/mechanics/calculators/run, src/mechanics/calculators/specs-generated, src/mechanics/effective-paths/damage-base, src/mechanics/effective-paths/damage-substats, src/mechanics/effective-paths/edamage-compute, src/mechanics/effective-paths/edamage-plan (+3 more)
 ...
 *
 * A target the caller sets wins over the game's own maximum; with no target
