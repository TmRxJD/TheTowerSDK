 ...
 */
/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    EffectiveRegenConfig, computeEffectiveRegen, EffectiveRegenUpgradeDefinition, EFFECTIVE_REGEN_UPGRADES, EffectiveRegenPathVariant, REGEN_PATH_VARIANTS, EffectiveRegenPlanOptions, EffectiveRegenPlan (+2 more)
 * depends    src/mechanics/effective-paths/coin-costs, src/mechanics/effective-paths/ehp-model, src/mechanics/effective-paths/hp, src/mechanics/effective-paths/lab-costs, src/mechanics/effective-paths/levels-schema, src/mechanics/effective-paths/planner (+1 more)
 * used by    src/mechanics/calculators/specs-generated, src/mechanics/effective-paths/ehp-from-sheet, src/mechanics/effective-paths/index
 * ─────────────────────────────────────────────── generated by `npm run map` ──
 */

import { effectiveRegen, effectiveWallRegen } from './hp'
import type { EffectiveHealthConfig, EffectiveHealthLevels } from './ehp-model'
...
export { ZERO_EFFECTIVE_REGEN_LEVELS } from './regen-levels'
