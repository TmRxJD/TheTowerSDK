 ...
 */
/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    DAMAGE_RUN_TYPES, DamageRunType, towerDamage, tradeOffDamagePerk, shockMultiplier, demonModeMastery, perfectFreeze, perfectFreezeCash (+4 more)
 * depends    src/mechanics/effective-paths/generics
 * used by    src/mechanics/calculators/run, src/mechanics/calculators/specs-generated, src/mechanics/effective-paths/edamage-compute, src/mechanics/effective-paths/edamage-config, src/mechanics/effective-paths/edamage-model, src/mechanics/effective-paths/edamage-plan (+1 more)
 * ─────────────────────────────────────────────── generated by `npm run map` ──
 */

import { standardPerksBonusScale } from './generics'
 ...
 * cash figure that would not be used. Cash ≤ 0 also returns 1 so `log10(0)`
 * cannot NaN the base (the planner pins path-start PF via
...
export function perfectFreeze(input: {
  ...
  // log10(0) is -Infinity and zeros CZ5 / NaNs DI5·ES5; no cash → no PF growth.
