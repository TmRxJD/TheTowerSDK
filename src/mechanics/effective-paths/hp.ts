 ...
 */
/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    DEFAULT_PERK_QUANTITY, SubstatInput, EffectiveHealthInput, effectiveHealth, EffectiveRegenInput, effectiveRegen, EffectiveDefenseAbsoluteInput, effectiveDefenseAbsolute (+17 more)
 * depends    —
 * used by    src/mechanics/calculators/specs-generated, src/mechanics/effective-paths/ehp-model, src/mechanics/effective-paths/index, src/mechanics/effective-paths/regen-plan
 * ─────────────────────────────────────────────── generated by `npm run map` ──
 */

/**
 * Assist substat contributions are scaled by the assist's "substat capacity",
 * which stone and lab investment both raise, and which the targets record only
