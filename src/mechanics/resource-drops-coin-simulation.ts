 ...
 * depends    src/data/chart-tables, src/data/index, src/internal/game-input-data/uw-stat-dropdown-math, src/mechanics/enemy-drops-simulation, src/mechanics/enemy-type-mix, src/mechanics/math (+9 more)
 * used by    src/knowledge/compartments/enemies, src/mechanics/calculators/specs-generated, src/mechanics/index, src/mechanics/resource-drops-coin-context
