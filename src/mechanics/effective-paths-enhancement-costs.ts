 ...
 * depends    src/data/workshop-enhancement-costs.json, src/data/workshop-enhancement-tracker-definitions
 * used by    src/mechanics/calculators/specs-generated, src/mechanics/effective-paths-edamage-plan, src/mechanics/effective-paths-eecon-discount, src/mechanics/effective-paths-eecon-plan, src/mechanics/effective-paths-ehp-plan, src/mechanics/index (+1 more)
