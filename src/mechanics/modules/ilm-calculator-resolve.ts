 ...
 * depends    src/data, src/data/modules/bonus, src/mechanics/bots/hit-multiplier, src/mechanics/modules/assist-module-efficiency, src/mechanics/modules/ilm-calculator-options, src/mechanics/modules/ilm-charge
 * used by    src/mechanics/calculators/specs-generated, src/mechanics/modules/index
 * ─────────────────────────────────────────────── generated by `npm run map` ──
 */
import { clampAssistMultiplierEfficiencyPct } from './assist-module-efficiency'
import { computeModuleStat, type ModuleCalcType } from '../../data/modules/bonus'
import { computeLabValueAtLevel, getSharedToolLabs } from '../../data'
import {
  chainLightningShockMultiplier,
  enemyHitMultiplier,
  type EnemyHitMultiplierInput,
} from '../bots/hit-multiplier'
import {
...
export function computeDimensionCoreMaxShockStack(
  ...
  return computeIlmUniqueModuleRarityBonus(ILM_UNIQUE_MODULE_ID_BY_KEY.dimensionCore, dimensionCoreRarity)
}
...
export function computeAcpShockwaveMultiplier(
  ...
  return computeIlmUniqueModuleRarityBonus(ILM_UNIQUE_MODULE_ID_BY_KEY.antiCubePortal, acpRarity)
}
