/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    parseModuleElsBonusPercent, ELS_ATTACK_MODULE_SUBSTAT_LABEL, ELS_HEALTH_MODULE_SUBSTAT_LABEL, VAULT_ELS_ATTACK_NODE_ID, VAULT_ELS_HEALTH_NODE_ID, VAULT_ELS_SKIP_PER_STAR, VAULT_ELS_MAX_STARS, ElsModuleSlotBonusesPct (+7 more)
 * depends    src/mechanics/enemies/level-skip
 * used by    src/internal/local-state/enemy-stats-calcs, src/internal/shared-tool-inputs/field-sync, src/mechanics/calculators/specs-generated, src/mechanics/modules/els-calculator-options, src/mechanics/modules/els-upgrade-path, src/mechanics/modules/index (+1 more)
