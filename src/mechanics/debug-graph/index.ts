/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    loadDebugGraph, loadDebugGraphDegraded, filterDebugGraph, buildDebugGraphIndex
 * depends    src/mechanics/debug-graph/data/debug-graph.v1.json, src/mechanics/debug-graph/schema, src/mechanics/debug-graph/session, src/mechanics/debug-graph/trace, src/mechanics/debug-graph/validate
 * used by    —
