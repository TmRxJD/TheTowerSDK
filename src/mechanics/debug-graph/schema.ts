/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    DebugNodeTypeSchema, DebugNodeType, DebugEdgeKindSchema, DebugEdgeKind, DebugNodeStatusSchema, DebugNodeSchema, DebugNode, DebugEdgeSchema (+6 more)
 * depends    —
 * used by    src/mechanics/debug-graph/index, src/mechanics/debug-graph/trace, src/mechanics/debug-graph/validate, src/mechanics/registry/build, src/mechanics/sdk-graph/invariants
