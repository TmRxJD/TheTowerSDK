/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    ILM_DAMAGE_MODULE_SUBSTAT_LABEL, ILM_MODULE_SUBSTAT_NONE, IlmModuleSubstatRarityChoice, IlmUniqueModuleRarityChoice, ILM_UNIQUE_MODULE_IDS, IlmUniqueModuleId, IlmSelectOption, parseIlmModuleSubstatBonus (+6 more)
 * depends    src/data/index
 * used by    src/internal/game-input-data/extended-dropdown-evaluators, src/internal/game-input-data/ilm-calculator-dropdown-math, src/mechanics/calculators/specs-generated, src/mechanics/ilm-calculator-resolve, src/mechanics/ilm-charge, src/mechanics/index
