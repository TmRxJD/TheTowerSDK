/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    computeTierNumber, EnemyDropsCardLevels, EnemyDropsLinkedSources, EnemyDropsRoiEconomyContext, guardianSourceLevelToNormalized, computeWaLevelFromCardLevel, computeWaveTimeSecondsFromUptime, computeWaveTimeSecondsFromWaCard (+13 more)
 * depends    src/data/index, src/internal/enemy-drops-calcs-local-state, src/internal/game-input-data/dropdown-evaluator, src/internal/labs-persistence, src/internal/shared-tool-inputs-extended, src/internal/shared-uptime-inputs (+2 more)
 * used by    src/internal/game-input-data/dropdown-evaluator, src/mechanics/calculators/specs-generated, src/mechanics/card-effect-lookup, src/mechanics/enemy-drops-simulation, src/mechanics/index, src/mechanics/resource-drops-coin-context
