 ...
 * depends    src/mechanics/coverage/data/sheets.v1.json, src/mechanics/coverage/schema, src/mechanics/sdk-graph/build-index, src/mechanics/sdk-graph/invariants, src/mechanics/sdk-graph/schema, src/mechanics/sdk-graph/validate
 * used by    src/mechanics/kernel/schema, src/mechanics/kernel/validate, src/mechanics/sdk-graph/index
