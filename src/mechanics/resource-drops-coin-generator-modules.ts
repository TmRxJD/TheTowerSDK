 ...
 * depends    src/data/bots, src/data/modules, src/internal/own-lookup, src/internal/shared-tool-inputs-extended, src/mechanics/uptime-core
 * used by    src/mechanics/calculators/specs-generated, src/mechanics/index, src/mechanics/resource-drops-coin-context, src/save/shared-tool-inputs-from-save-extended
