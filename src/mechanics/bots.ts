 ...
 */
/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    botTowerFactor, botEffectiveRadius, getBotBenefit, flameBotDamageReductionMultiplier, FlameBotReductionInput, getFlameBotDamageReduction, ThunderBotLingerInput, getThunderBotLinger (+4 more)
 * depends    src/mechanics/constants, src/mechanics/math
 * used by    src/mechanics/bot-medal-simulation, src/mechanics/calculators/specs-generated, src/mechanics/damage-reduction, src/mechanics/damage-redux-layers, src/mechanics/index
