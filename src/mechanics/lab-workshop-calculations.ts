 ...
 * depends    src/internal/own-lookup, src/mechanics/lab-workshop-constants
 * used by    src/mechanics/calculators/specs-generated, src/mechanics/index, src/mechanics/workshop-table-build
