 ...
 */
/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    ELS_BC_SKIP_REDUCTION_PCT_PER_LEVEL, MAX_BC_GLOBAL_REDUCTION_LAB_LEVEL, MAX_BC_SPECIFIC_LAB_LEVEL, mergeWorkshopBcLabLevels, bcCounterLabBenefitIncreaseAtLevel, globalBcReductionBenefitFraction, elsSkipSubtractBenefitFraction, elsBcReductionLabBenefitFraction (+11 more)
 * depends    src/data/index, src/mechanics/battle-condition-config, src/mechanics/battle-conditions, src/mechanics/enemy-level-skip, src/mechanics/math, src/mechanics/tournament-heat-bc
 * used by    src/mechanics/calculators/specs-generated, src/mechanics/enemy-stats-simplified, src/mechanics/index
