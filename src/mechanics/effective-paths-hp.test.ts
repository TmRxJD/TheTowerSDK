...
const ADAPTERS: Record<string, (args: Args) => number> = {
  ...
  EPH_HEALTH: a => effectiveHealth({
    ...
    hasCommonTournamentOverride: bool(a, 9),
    hasRareTournamentOverride: bool(a, 10),
    relicPct: num(a, 11),
    vaultPct: num(a, 12),
  ...
  EPH_REGEN: a => effectiveRegen({
    ...
    hasRegenTournamentOverride: bool(a, 13),
    hasRareTournamentOverride: bool(a, 14),
    introSprintLabLevel: num(a, 15),
    relicPct: num(a, 16),
    vaultPct: num(a, 17),
    hasSwampMastery: bool(a, 18),
    swampMasteryLevel: num(a, 19),
  }),
...
describe('effective paths eHP branches the template does not exercise', () => {
  it('stacks health multipliers independently', () => {
    const base = {
      ...
      hasPerk: false,
      perkBonusLabLevel: 0,
      hasCommonTournamentOverride: false,
      hasRareTournamentOverride: false,
      relicPct: 0,
      vaultPct: 0,
