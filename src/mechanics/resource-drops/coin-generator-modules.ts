/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    GENERATOR_UNIQUE_EFFECT_TO_TEMPLATE_ID, COIN_RELEVANT_GENERATOR_UNIQUE_IDS, CoinRelevantGeneratorUniqueId, EquippedGeneratorUnique, computeGeneratorUniqueRarityBonus, generatorUniqueTemplateFromEffectId, findEquippedGeneratorUnique, compressorRarityFromGeneratorUnique (+4 more)
 * depends    src/data/bots/data, src/data/modules/modules, src/internal/shared-tool-inputs/extended, src/mechanics/uptime/compute, src/support/own-lookup
...
import { getBotEffectiveRangeValue } from '../../data/bots/data'
import { getModuleTemplate } from '../../data/modules/modules'
import type { Compressor } from '../uptime/compute'
