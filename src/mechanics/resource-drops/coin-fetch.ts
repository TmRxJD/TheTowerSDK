/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    FETCH_COIN_CPM_FRACTION, estimateFetchCoinsFromRunCpm, estimateRunDurationMinutes
 * depends    src/mechanics/enemies/drops-game-data, src/mechanics/enemies/drops-simulation
 * used by    src/mechanics/calculators/specs-generated, src/mechanics/resource-drops/coin-simulation, src/mechanics/resource-drops/index
 * ─────────────────────────────────────────────── generated by `npm run map` ──
 */
import { FETCH_LOOT_OUTCOME_WEIGHTS } from '../enemies/drops-game-data'
import { type EnemyDropsSimulationInput, simulateFetchDrops } from '../enemies/drops-simulation'
