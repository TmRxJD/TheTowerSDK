/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    WAVE_SKIP_SKIPPED_WAVE_MULT, computeBossWaveInterval, computeBossWaveIntervalFromTier, BOSS_WAVE_INTERVAL_BY_TIER, EnemyDropsSimulationInput, EnemyDropsRoiBuildContext, EnemyDropsWaveContext, EnemyDropsYieldBreakdown (+24 more)
 * depends    src/data/chart-tables, src/data/currency, src/data/enemies, src/data/index, src/formatting/tool-formatting, src/mechanics/card-costs (+4 more)
 * used by    src/mechanics/calculators/specs-generated, src/mechanics/elite-spawn-chance, src/mechanics/enemy-drops-context, src/mechanics/index, src/mechanics/resource-drops-coin-fetch, src/mechanics/resource-drops-coin-simulation
