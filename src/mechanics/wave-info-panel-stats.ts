 ...
 * depends    src/data/index, src/mechanics/battle-condition-config, src/mechanics/elite-spawn-chance, src/mechanics/enemy-wave-stats, src/mechanics/wave-accelerator-spawn-rate-cap, src/mechanics/wave-info-panel-constants (+1 more)
