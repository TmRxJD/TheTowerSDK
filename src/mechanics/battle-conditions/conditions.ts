/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    ELS_REDUCTION_SUBTRACT_SCALE, ELS_REDUCTION_CAMPAIGN_HEAT_DIVISOR, getTotalBcModifierFraction, elsReductionSubtractAbsolute, skipReductionSubtractAmount, skipReductionMultiplyFactor, skipDecayWaveInterval, applySkipDecay
 * depends    —
 * used by    src/mechanics/battle-conditions/config, src/mechanics/battle-conditions/index, src/mechanics/calculators/specs-generated, src/mechanics/enemies/level-skip, src/mechanics/labs/bc-counter-labs
