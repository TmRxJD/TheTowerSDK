 ...
 */
/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    BattleConditionName, ENEMY_STATS_BATTLE_CONDITION_NAMES, EnemyStatsBattleConditionName, ENEMY_STATS_BATTLE_CONDITION_DEFINITIONS, BattleConditionSelection, WorkshopTableOffset, BattleConditionEnemyStatEffect, WAVE_INFO_RESISTANCE_BATTLE_CONDITION_NAMES (+37 more)
 * depends    src/data/tiers/data, src/data/tournaments/data, src/mechanics/battle-conditions/conditions, src/mechanics/battle-conditions/tournament-heat-bc, src/mechanics/waves/info-enemy-constants
 * used by    src/internal/local-state/enemy-stats-calcs, src/internal/shared-tool-inputs/extended, src/mechanics/battle-conditions/index, src/mechanics/calculators/specs-generated, src/mechanics/combat/damage-redux-wave-stats, src/mechanics/enemies/stats-simplified (+8 more)
...
} from '../../data/tiers/data'
import type { TournamentLeague } from '../../data/tournaments/data'
import { WAVE_INFO_WORKSHOP_OFFSETS, WAVE_INFO_WORKSHOP_SCALE } from '../waves/info-enemy-constants'
import { getTotalBcModifierFraction } from './conditions'
import {
...
export { WAVE_INFO_RESISTANCE_HP_FLOAT_PER_LEVEL, WAVE_INFO_RESISTANCE_DAMAGE_FLOAT_PER_LEVEL } from '../waves/info-enemy-constants'
...
export const BC_ENEMY_STAT_EFFECT_BY_NAME: Partial<Record<BattleConditionName, BattleConditionEnemyStatEffect>> = {
...
export function aggregateWorkshopTableFloat(
  ...
  for (const bc of conditions) {
    if (!bc.enabled || bc.level <= 0) continue
    const effect = BC_ENEMY_STAT_EFFECT_BY_NAME[bc.name]
