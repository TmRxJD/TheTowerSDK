 ...
 * depends    src/data/guardian-upgrades, src/internal/uptime-uw-field-map, src/mechanics/assist-module-efficiency, src/mechanics/uw-stat-values
 * used by    src/data/bots, src/internal/game-input-data/registry-builders, src/internal/game-input-data/uptime-relic-dropdown-math, src/internal/game-input-data/uptime-substat-dropdown-math, src/internal/shared-uptime-inputs, src/internal/uptime-state-builder (+7 more)
