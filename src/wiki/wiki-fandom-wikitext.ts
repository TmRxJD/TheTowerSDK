 ...
 * depends    src/wiki/wiki-fandom-media, src/wiki/wiki-fandom-wikitext-table
 * used by    src/mechanics/calculators/specs-generated, src/wiki/index, src/wiki/wiki-sources
