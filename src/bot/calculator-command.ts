 ...
 */
/* ── file map ─────────────────────────────────────────────────────────────────
 * exports    calculatorCommand, calculatorCommands
 * depends    src/bot/types, src/builders, src/formatting, src/support/own-lookup
 * used by    src/bot/index
 * ─────────────────────────────────────────────── generated by `npm run map` ──
 */
import { CALCULATOR_BUILDERS, type CalculatorBuilder, type CalculatorField, type CalculatorResultBase } from '../builders'
import { formatLargeNumber } from '../formatting'
import { ownLookup } from '../support/own-lookup'
import type { BotCommand, BotCommandOption, BotReply, BotReplyField, CalculatorCommandOptions } from './types'
